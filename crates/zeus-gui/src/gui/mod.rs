use eframe::
    egui::{
        vec2, Color32, ComboBox, FontId, RichText, TextEdit, Ui
    };

use std::sync::Arc;
use misc::frame;
use crate::{ theme::ZeusTheme, fonts::roboto_regular, gui::swap_ui::SwapUI};
    ...
    pub fn select_chain(&mut self, ui: &mut Ui, data: &mut AppData) {
        ...
        ui.horizontal(|ui| {
            ...
            ComboBox::from_label("")
                ...
                ui.add(self.theme.icons.connected_icon(data.connected(data.chain_id.id())));
